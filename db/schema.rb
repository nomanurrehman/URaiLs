...
ActiveRecord::Schema.define(version: 20170906144418) do
  ...
  create_table "ownerships", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.index ["url_id"], name: "index_ownerships_on_url_id"
    t.index ["user_id", "url_id"], name: "index_ownerships_on_user_id_and_url_id", unique: true
  ...
  create_table "users", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.date "date_of_birth", default: "1970-01-01", null: false
